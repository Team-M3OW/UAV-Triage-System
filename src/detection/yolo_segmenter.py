...
def segment_people_yolo(input_video, output_dir='masked_frames', output_video='outputs/segmented_video.mp4', model_size='n', conf=0.3):
    ...
    print(f"[INFO] Loading YOLOv8-seg: {model_path}")
    ...
    frame_idx = 0
    print(f"[INFO] Segmenting people ({total_frames} frames)...")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_video', type=str, default='demo_video/monkey.mp4')
    parser.add_argument('--output_dir', type=str, default='masked_frames')
    parser.add_argument('--output_video', type=str, default='outputs/segmented_video.mp4')
