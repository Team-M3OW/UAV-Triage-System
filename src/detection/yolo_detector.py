...
def segment_people_yolo_bbox(input_video, output_video, temp_dir='temp_frames', model_size='n', conf=0.3, crop_size=(256, 256)):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_folder', type=str, default='cropped_videos')
